...
from ..cl_controllers.agem_controller import AGEMController
from ..utils.cl_experience import CL_Experience
from ..trainers.cl_trainer_callback import AGEMCallback, EarlyStoppingCallback
...
def main(args):
    ...
    cl_controller = AGEMController(
        model=model,
        trainer_args=training_args,
        data_collator=data_collator,
        experiences=experiences,
        strategy_callback=cl_callback,
        patterns_per_exp=args.agem_patterns_per_exp,  # 11304,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-r", "--raw_data_path", type=str, help="path to raw dataset files"
    )
    parser.add_argument(
        "-d",
        "--dataset_save_path",
    ...
    parser.add_argument(
        "--agem_patterns_per_exp",
        type=int,
        default=100,
        help="number of patterns that fills buffers.",
    )
    parser.add_argument(
        "--agem_sample_size",
        type=int,
        default=100,
        help="number of patterns to sample from experience buffers.",
    )
    ...
    parser.add_argument(
        ...
        help="name of the tokenizer file to save",
    )
